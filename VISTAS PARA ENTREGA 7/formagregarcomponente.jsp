	...
	<div class="container">
		...
		<div class="row">
		  ...
		  <br>
			...
			<div><h2>Para agregar un nuevo COMPONENTE DE PLATO</h2></div>
			<div><h4>Complete los siguientes datos (la casilla tildada significa que "si" es apto)</h4></div>
			...
			<div >
				...
				<form:form id="usuarioRegisterForm" modelAttribute="administrador" method="post" action="guardarAdministrador">
				  ...
				  <div class="form-group">
				    ...
				    <form:checkbox value="aptoceliaco" path="apellido" cssClass="form-control" required="required"/> <!-- aca pasa lo mismo, dependiendo del controlador me parece que hay que cambiar el value y el path -->
				    <form:errors path="apellido" cssClass="error"/>
				  </div>
				   <div class="form-group">
				    <label>Indique si es apto para diabeticos</label>
				    <form:checkbox value="aptodiabetico" path="direccion" cssClass="form-control" required="required"/> <!-- aca pasa lo mismo, dependiendo del controlador me parece que hay que cambiar el value y el path -->
				    <form:errors path="direccion" cssClass="error"/>
				  </div>
		
				  <div class="form-group">
				  	<label>Indique si es apto para hipertenso</label>
				  	<form:checkbox value="aptohipertenso" path="user" cssClass="form-control" required="required"/> <!-- aca pasa lo mismo, dependiendo del controlador me parece que hay que cambiar el value y el path -->
				  	<form:errors path="user" cssClass="error"/>
				  </div>
				   <div class="form-group">
				    <label>Indique si es apto lactosa</label>
				    <form:checkbox value="aptolactosa" path="pass" cssClass="form-control" required="required"/> <!-- aca pasa lo mismo, dependiendo del controlador me parece que hay que cambiar el value y el path -->
