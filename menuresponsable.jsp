	...
	<div class="container">
		...
		<div class="row">
		  ...
		  <br>
			...
			<div><h1>BIENVENIDO RESPONSABLE DE SEDE</h1></div>
			<div style="height:100px"><h4>LAS SIGUIENTES OPCIONES SON VALIDAS PARA LA SEDE DE LA CUAL ES RESPONSABLE </h4></div>
			
			<div style="height:300px">
				
				<div>
				<button type="button" class="btn btn-primary btn-lg btn-block">Usuarios habilitados a la compra de tickets</button>
				<button type="button" class="btn btn-default btn-lg btn-block">Informacion de compra de ticket</button>
				</div>
				
				<div>
				<button type="button" class="btn btn-primary btn-lg btn-block">Registro de pagos realizados</button>
